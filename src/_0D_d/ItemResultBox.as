...
package _0D_d {
    ...
    public class ItemResultBox extends Frame {
        ...
        private function addIcon() {
            ...
            var _local5:int = ObjectLibrary.getItemNameColor(this.itemType_);
            var _local3:BitmapData = ObjectLibrary.getRedrawnTextureFromType(this.itemType_, 60, true, true, _local2, 0, _local5);
            if(this.itemData_ != null && this.itemData_.hasOwnProperty("TextureFile") && this.itemData_.TextureFile != "") {
                _local3 = ObjectLibrary.getRedrawnTextureFromTypeCustom(this.itemType_, 60, true, this.itemData_, true, _local2, 0, _local5);
            }
            ...
            var _local4:SimpleText = new SimpleText(30, (this.itemData_ != null && this.itemData_.hasOwnProperty("NameColor")) ? this.itemData_.NameColor : ObjectLibrary.getItemNameColor(this.itemType_), false, 0, 0, "CHIP SB");
