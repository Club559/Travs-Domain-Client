...
package _0D_d {
    ...
    import _sP_.MarketplaceInventory;
    ...
    public class GiveBoxSearcher extends Sprite {
        ...
        private function giveItem(_arg1:int, _arg2:Object) {
            var _local1:String = ObjectLibrary.TypeToId[_arg1];
            if(_local1 == null) {
                return;
            }
            if(_arg2 != null && _arg2 != {}) {
                this.gs_.gsc_.playerText("/give " + _local1 + " " + JSON.stringify(_arg2));
            } else {
                this.gs_.gsc_.playerText("/give " + _local1);
            }
            this.giveBox_.close();
        }
    }
