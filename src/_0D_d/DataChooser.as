...
package _0D_d {
    ...
    public class DataChooser extends Frame {
        ...
        private function addIcon() {
            ...
            var _local3:BitmapData = ObjectLibrary.getRedrawnTextureFromType(this.itemType_, 60, true, false, _local2, 0, _local4);
            if(this.itemData_ != null && this.itemData_.hasOwnProperty("TextureFile") && this.itemData_.TextureFile != "") {
                _local3 = ObjectLibrary.getRedrawnTextureFromTypeCustom(this.itemType_, 60, true, this.itemData_, false, _local2, 0, _local4);
            }
