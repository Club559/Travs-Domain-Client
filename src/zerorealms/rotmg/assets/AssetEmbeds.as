package zerorealms.rotmg.assets {
  ...
  public class AssetEmbeds {
    ...
    public static var abilitiesEmbed_:Class = EmbeddedAssets_abilitiesEmbed_;
    public static var pokeballsEmbed_:Class = EmbeddedAssets_pokeballsEmbed_;
    public static var pokemonFrontEmbed_:Class = EmbeddedAssets_pokemonFrontEmbed_;
    public static var pokemonBackEmbed_:Class = EmbeddedAssets_pokemonBackEmbed_;
