...
public class Notif extends Sprite {
    ...
    private const closeButton:_str152 = ObjectLibrary._str2799(Notif.WIDTH);
    ...
    public function Notif(_arg1:GlobalNotification, _arg2:GameSprite) {
    ...
    private function _str4865():void{
        this.x = (800 + (Notif.WIDTH + 6));
        this.y = Parameters.data_.notifLocation ? 6 : (600 - (Notif.HEIGHT + 6));
    }
