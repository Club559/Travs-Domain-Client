...
public class _2j extends Slot {
    ...
    private function draw(_arg1:Boolean):void {
        _O_m._03d(this, this._0L_K_);
        var _local12:int = ObjectLibrary.getItemNameColor(this.item_);
        var _local8:* = ObjectLibrary.getRedrawnTextureFromType(this.item_, 80, true, true, 5, 0, _arg1 ? _local12 : 0);
        if(this.data_ != null && this.data_.hasOwnProperty("TextureFile") && this.data_.TextureFile != "") {
            _local8 = ObjectLibrary.getRedrawnTextureFromTypeCustom(this.item_, 80, true, this.data_, true, 5, 0, _arg1 ? _local12 : 0);
        }
        var _local9:* = ObjectLibrary._Q_F_[this.item_];
        if (_local9.hasOwnProperty("Doses")) {
            _local8 = _local8.clone();
            var _local11:* = new SimpleText(12, 0xFFFFFF, false, 0, 0, "Myriad Pro");
            _local11.text = String(_local9.Doses);
            _local11.updateMetrics();
            _local8.draw(_local11, _1U_);
        }
        var _local10:* = _H_K_(this.item_, type_, false);
