...
public class _061 extends Sprite {
    ...
    public function draw(_arg1:Boolean):void {
        if(this.bitmap_ != null) {
            this.removeChild(this.bitmap_);
        }
        var _local6:SimpleText;
        var _local3:XML = ObjectLibrary._Q_F_[this._0M_X_];
        var _local4:Number = 5;
        if (_local3.hasOwnProperty("ScaleValue")) {
            _local4 = _local3.ScaleValue;
        }
        var _local7:int = ObjectLibrary.getItemNameColor(this._0M_X_);
        var _local5:BitmapData = ObjectLibrary.getRedrawnTextureFromType(this._0M_X_, 80, true, false, _local4, 0, _arg1 ? _local7 : 0);
        if(this.data_ != null && this.data_.hasOwnProperty("TextureFile") && this.data_.TextureFile != "") {
            _local5 = ObjectLibrary.getRedrawnTextureFromTypeCustom(this._0M_X_, 80, true, this.data_, false, _local4, 0, _arg1 ? _local7 : 0);
        }
