...
public class StatData {
    ...
    public static const ACTIVE_QUESTS_STAT:int = 86;
    public static const FINISHED_QUESTS_STAT:int = 87;
    public static const COMPLETED_QUESTS_STAT:int = 88;
    public static const ABILITY_1_STAT:int = 89;
    public static const ABILITY_2_STAT:int = 90;
    public static const ABILITY_3_STAT:int = 91;
    public static const ABILITYCD_1_STAT:int = 92;
    public static const ABILITYCD_2_STAT:int = 93;
    public static const ABILITYCD_3_STAT:int = 94;
    ...
    public function _I_3():Boolean {
        switch (this._0F_4) {
            ...
            case EFFECT_STAT:
            case ACTIVE_QUESTS_STAT:
            case FINISHED_QUESTS_STAT:
            case COMPLETED_QUESTS_STAT:
                return (true);
        }
        return (false);
    }
