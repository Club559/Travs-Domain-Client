...
public class _1f {
    ...
    public static const ACCEPTQUEST:int = 96;
    public static const COMPLETEQUEST:int = 97;
    ...
    public function _1f(_arg1:GameSprite, _arg2:Server, _arg3:int, _arg4:Boolean, _arg5:int, _arg6:int, _arg7:ByteArray, _arg8:String) {
        ...
        this._08._g9(GLOBAL_NOTIFICATION, GlobalNotification, this.globalNotif_);
...
//        }
    ...
    public function acceptQuest(_arg1:int):void {
        var _local2:AcceptQuest = (this._08._Y_E_(ACCEPTQUEST) as AcceptQuest);
        _local2.questType_ = _arg1;
        this._08.sendMessage(_local2);
    }

    public function completeQuest(_arg1:int):void {
        var _local2:CompleteQuest = (this._08._Y_E_(COMPLETEQUEST) as CompleteQuest);
        _local2.questType_ = _arg1;
        this._08.sendMessage(_local2);
    }

    public function changeNexus():void {
        var _local2:ChangeNexus = (this._08._Y_E_(CHANGENEXUS) as ChangeNexus);
        this._08.sendMessage(_local2);
    }

    public function useAbility(_arg1:int, _arg2:int, _arg3:Number, _arg4:Number):void {
        var _local7:UseAbility = (this._08._Y_E_(USEABILITY) as UseAbility);
        _local7.time_ = _arg1;
    ...
    public function editMap(_arg1:int, _arg2:int, _arg3:Number, _arg4:Number):void {
        var _local1:EditMap = (this._08._Y_E_(EDITMAP) as EditMap);
        _local1.mode_ = _arg1;
        _local1.type_ = _arg2;
        _local1.pos_.x_ = _arg3;
        _local1.pos_.y_ = _arg4;
    ...
    private function _C_i(_arg1:_T_m):void {
        ...
        _local4.reset(_arg1.containerType_, 0, _arg1.ownerId_, _arg1.bulletId_, _arg1.angle_, this.gs_.lastUpdate_, _arg1.fromAbility_);
    ...
    private function globalNotif_(_arg1:GlobalNotification):void {
    ...
    private function notif_(_arg1:GlobalNotification):void {
        ...
        for each (_local4 in _arg2) {
            ...
            switch (_local4._0F_4) {
                ...
                case StatData.EFFECT_STAT:
                    ...
                    break;
                case StatData.ACTIVE_QUESTS_STAT:
                    (_arg1 as Player).activeQuests = QuestLibrary.fromQuestList(_local4._3x);
                    break;
                case StatData.FINISHED_QUESTS_STAT:
                    (_arg1 as Player).finishedQuests = QuestLibrary.fromQuestList(_local4._3x);
                    break;
                case StatData.COMPLETED_QUESTS_STAT:
                    (_arg1 as Player).completedQuests = QuestLibrary.fromQuestList(_local4._3x);
                    break;
                case StatData.ABILITY_1_STAT:
                case StatData.ABILITY_2_STAT:
                case StatData.ABILITY_3_STAT:
                    (_arg1 as Player).abilities[int(_local4._0F_4 - StatData.ABILITY_1_STAT)] = _local8;
                    break;
                case StatData.ABILITYCD_1_STAT:
                case StatData.ABILITYCD_2_STAT:
                case StatData.ABILITYCD_3_STAT:
                    (_arg1 as Player).abilityCooldowns[int(_local4._0F_4 - StatData.ABILITYCD_1_STAT)] = _local8;
                    break;
            }
        }
    }
