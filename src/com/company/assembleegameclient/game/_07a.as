...
public class _07a {
    ...
    private function onMouseDown(_arg1:MouseEvent):void {
        ...
        if(this.gs_._V_1.editing_) {
            var _local4:Point = this.gs_.map_.pSTopW(this.gs_.map_.mouseX, this.gs_.map_.mouseY);
            var _local5:int = this.gs_._V_1.currentEdit_._09V_;
            if (_local4 != null) {
                if(_arg1.shiftKey) {
                    this.gs_.gsc_.editMap(_M_u._S_E_, 0, _local4.x, _local4.y);
                } else {
                    if (_local5 == _M_u._6h) { //Tiles
                        //this.gs_.map_.setGroundTile(_local4.x, _local4.y, this.gs_._V_1.editTile_._N_T_());
                        this.gs_.gsc_.editMap(_local5, this.gs_._V_1.editTile_._N_T_(), _local4.x, _local4.y);
                    } else if (_local5 == _M_u._S_E_) { //Objects
                        /*var _local6:GameObject = ObjectLibrary._075(this.gs_._V_1.editObj_._N_T_());
                         if (_local6 != null) {
                         _local6.setObjectId(BasicObject._7y());
                         this.gs_.map_.addObj(_local6, _local4.x, _local4.y);
                         }*/
                        this.gs_.gsc_.editMap(_local5, this.gs_._V_1.editObj_._N_T_(), _local4.x, _local4.y);
                    }
                }
            }
        } else {
    ...
    private function _0A_Y_(_arg1:KeyboardEvent):void {
        ...
        switch (_arg1.keyCode) {
            ...
            case Parameters.data_.useSpecial:
                ...
                break;
            case Parameters.data_.useAbility1:
                _local3.useAbility(0, this.gs_.map_.mouseX, this.gs_.map_.mouseY);
                break;
            case Parameters.data_.useAbility2:
                _local3.useAbility(1, this.gs_.map_.mouseX, this.gs_.map_.mouseY);
                break;
            case Parameters.data_.useAbility3:
                _local3.useAbility(2, this.gs_.map_.mouseX, this.gs_.map_.mouseY);
                break;
    ...
    private function _H_H_(_arg1:KeyboardEvent):void {
        ...
        switch (_arg1.keyCode) {
            ...
            case Parameters.data_.useSpecial:
                ...
                break;
            case Parameters.data_.giveHotkey:
