...
public class Parameters {
    ...
    public static const _1h:Boolean = true;
    ...
    public static const musicUrl_:String = "travoos.com/td";
    ...
    public static const levelCap_:int = 50;
    ...
    public static function _fK_():String {
        ...
        if (_I_O_()) {
            return ("213.112.243.66:8080"); // _I_O_() -> TRUE -- Testing Enabled
        }
        return ("213.112.243.66:8080"); // _I_O_() -> FALSE -- Testing Disabled
    }
    ...
    public static function _fX_():void {
        ...
        _la("togglePerformanceStats", _H_V_.UNSET);
        _la("options", _H_V_.O);
        _la("toggleCentering", _H_V_.UNSET);
        _la("chat", _H_V_.ENTER);
        _la("chatCommand", _H_V_._jE_);
        _la("tell", _H_V_.TAB);
        _la("guildChat", _H_V_.G);
        _la("partyChat", _H_V_.P);
        _la("toggleFullscreen", _H_V_.UNSET);
        _la("switchTabs", _H_V_.B);
        _la("marketHotkey", _H_V_.UNSET);
        _la("giveHotkey", _H_V_.UNSET);
        _la("useAbility1", _H_V_.C);
        _la("useAbility2", _H_V_.X);
        _la("useAbility3", _H_V_.Z);
