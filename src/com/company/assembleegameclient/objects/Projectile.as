...
public class Projectile extends BasicObject {
    ...
    public function reset(_arg1:int, _arg2:int, _arg3:int, _arg4:int, _arg5:Number, _arg6:int, _arg7:Boolean = false):void {
        var _local8:Number;
        clear();
        ...
        if(!_arg7) {
            ...
            this._P_d = AbilityLibrary.Props[this.containerType_];
        }
