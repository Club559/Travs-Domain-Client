...
public class Player extends Character {
    ...
    public var activeQuests:Vector.<String> = new Vector.<String>();
    public var finishedQuests:Vector.<String> = new Vector.<String>();
    public var completedQuests:Vector.<String> = new Vector.<String>();
    ...
    override protected function getTexture(_arg1:_0D_v, _arg2:int):BitmapData {
        ...
        //    _qm[_local8] = _local9;
        //}
        var _local9:BitmapData = TextureRedrawer.outlineGlow(_local8, 0, this._2v == -1 ? 0 : this._2v);
        if (((isPaused()) || (_C_H_()))) {
    ...
    public function useAbility(_arg1:int, _arg2:Number, _arg3:Number):void {
        ...
        var _local3:int = int(_local2.MpCost);
        var _local4:Point = map_.pSTopW(_arg2, _arg3);
        if (_local4 == null) {
            _5T_.play("error");
            return;
        }
        if (abilityCooldowns[_arg1] > 0) {
            _5T_.play("error");
            return;
        }
