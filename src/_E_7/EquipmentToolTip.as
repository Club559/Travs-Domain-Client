...
public class EquipmentToolTip extends _for_ {
    ...
    public function EquipmentToolTip(_arg1:int, _arg2:Player, _arg3:int, _arg4:String, _arg5:uint = 1, _arg6:Boolean = false, _arg7:Object = null) {
        ...
        var _local7:uint = ((((this._0G_J_ && this.meetsLevel) || ((this.player_ == null)))) ? 0x363636 : 6036765);
    ...
    private var rarity_:SimpleText;
    ...
    private function initIcon():void {
        ...
        var _local4:int = ObjectLibrary.getItemNameColor(this.objectType_);
        var _local3:BitmapData = ObjectLibrary.getRedrawnTextureFromType(this.objectType_, 60, true, true, _local2, 0, _local4);
        if(this.itemData_ != null && this.itemData_.hasOwnProperty("TextureFile") && this.itemData_.TextureFile != "") {
            _local3 = ObjectLibrary.getRedrawnTextureFromTypeCustom(this.objectType_, 60, true, this.itemData_, true, _local2, 0, _local4);
        }
    ...
    private function initTier():void {
        ...
        this._V_0.x = (_be - 28);
        this.rank_.setAlign(TextFormatAlign.RIGHT);
    ...
    private function initName():void {
        var _local1:int = ObjectLibrary.getItemNameColor(this.objectType_); //((this._0G_J_ && this.meetsLevel) || this.player_ == null) ? 0xFFFFFF : 16549442;
    ...
    private function addLine(_arg1:int, _arg2:int):void {
        switch (_arg2) {
            case 0:
                this.line_ = new _return((_be - 12), 0);
                this.line_.x = 8;
                this.line_.y = _arg1;
                addChild(this.line_);
                return;
            ...
            case 2:
                ...
                return;
            case 3:
                this.line3_ = new _return((_be - 12), 0);
                this.line3_.x = 8;
                this.line3_.y = _arg1;
    ...
    private function addElem():void {
        ...
        if (((!((this._a2.length == 0))) || (!((this._gE_.text == ""))))) {
            ...
            this._f8.x = 4;
            this._f8.y = (this.rarity_.text != "" || this.level_.text != "" || this.actualName_.text != "") ? (this.line1_.y + 4) : (this.line_.y + 4);
            addChild(this._f8);
    ...
    private function initRarity():void {
        this.rarity_ = new SimpleText(fontSize, ObjectLibrary.getItemNameColor(this.objectType_), false, _be, 0, fontName);
        this.rarity_.setBold(true);
        this.rarity_.text = ObjectLibrary.getRarity(this.objectType_);
        this.rarity_.x = 4;
        this.rarity_.y = (this.level_.text != "") ? (this.level_.y + this.level_.textHeight) : ((this._C_G_.y + this._C_G_.height) + 8);
        if (this.rarity_.text != "") {
            addChild(this.rarity_);
            this.addLine(((this.rarity_.y + fontSize) + 8), 1);
        } else if (this.level_.text != "") {
