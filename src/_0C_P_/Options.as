...
public class Options extends Sprite {
    ...
    private function hotkeys_():void {
        ...
        this._yZ_(new _G_X_("giveHotkey", "Give Item", "Opens the item give box (admin-only)"));
    ...
    private function graphics_():void {
        ...
        this._yZ_(new _0I_j("notif", new <String>["On", "Off"], [true, false], "Toggle Notification", "Toggle wether or not to show the Notification", this.notif_));
        this._yZ_(new _0I_j("notifLocation", new <String>["Top", "Bottom"], [true, false], "Notification's Location", "Toggle where the Notification will be shown", null, !(Parameters.data_.notif)));
        ...
        while (_local1 < this._03a.length) {
            ...
            if (_local2) {
                if ((((_local2._W_Y_ == "notifLocation")))) {
                    _local2._J_r(!(Parameters.data_.notif));
                }
            }
            _local1++;
        }
